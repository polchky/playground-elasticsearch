...
console.log("Starting BDD with Yadda");
...
console.log("domain 1 " + util.inspect(process.domain));
dom.run(function() {
	console.log("domain 2 " + util.inspect(process.domain));
	new Yadda.FeatureFileSearch('test/features').each(function(file) {
		console.log("domain 3 " + util.inspect(process.domain));		
		
		featureFile(file, function(feature) {
			console.log("domain 4 " + util.inspect(process.domain));
			console.log("domain 5 " + util.inspect(process.domain));
			console.log("BDD feature");
			console.log(feature);

			var library = require("./test/library");
			console.log("I have my library");
			var yadda = Yadda.createInstance(library);
			console.log("I have my yadda");
